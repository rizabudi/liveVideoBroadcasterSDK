...
public class LiveVideoBroadcaster extends Service implements ILiveVideoBroadcaster, CameraHandler.ICameraViewer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void init(Activity activity, GLSurfaceView glView, IByteReceive byteReceive) {
        try {
    ...
    public boolean startBroadcasting(String rtmpUrl) {
        ...
        try {
            ...
            if (result) {
                ...
                audioThread = new AudioRecorderThread(SAMPLE_AUDIO_RATE_IN_HZ, recordStartTime, audioHandler, byteReceive);
                audioThread.start();
                isRecording = true;
